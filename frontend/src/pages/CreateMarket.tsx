...
const CreateMarket = () => {
    ...
    useEffect(() => {
        if (isSuccess && txHash) {
            toastTxSuccess(txHash, "Market created successfully!");
    ...
    useEffect(() => {
        if (isConfirmError && txHash) {
            toastTxError(txHash, confirmError || new Error("Transaction failed"));
            setIsCreating(false);
        }
    }, [isConfirmError, txHash, confirmError]);
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-green-500/10 border border-green-500/20 p-4 rounded-lg">
                                <div className="flex justify-between items-center">
                                    <span className="text-sm text-green-600 font-medium">Free to Create</span>
                                    <span className="text-sm text-muted-foreground">Only gas required</span>
                                </div>
                            </div>
